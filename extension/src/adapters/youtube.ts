...
export const youtube: SiteAdapter = {
  ...
  rules: [
    { selector: "ytd-video-renderer, ytd-rich-item-renderer, ytd-compact-video-renderer, ytd-grid-video-renderer, ytd-playlist-video-renderer, yt-lockup-view-model:not(ytd-rich-item-renderer yt-lockup-view-model)",
