...
export const adapterVariants = ([
  ...
  { site: "gmail", rule: 0, html: '<table><tbody><tr class="zA" data-fixture="extra"><td class="y6">Example sender</td><td class="xW"><span class="bog">Spam offer</span><span class="y2">50% off this product today.</span></td></tr><tr class="zA" data-retain><td class="y6">Keep sender</td><td class="xW"><span class="bog">Keep this message</span></td></tr></tbody></table>' },
