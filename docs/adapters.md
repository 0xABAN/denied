...
| --- | --- | --- |
| YouTube | Video-card renderers; reel player; comment renderer; watch player plus `ytd-watch-metadata` (legacy above-the-fold fallback) | Search/watch boundaries observed; other layouts remain fixture-tested. No pixels/audio analysis. |
